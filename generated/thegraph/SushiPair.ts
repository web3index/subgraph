...
export class SushiPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SushiPair extends ethereum.SmartContract {
  static bind(address: Address): SushiPair {
    return new SushiPair("SushiPair", address);
  }
  ...
  burn(to: Address): SushiPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to),
    ]);

    return new SushiPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }

  try_burn(to: Address): ethereum.CallResult<SushiPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SushiPair__burnResult(value[0].toBigInt(), value[1].toBigInt()),
    );
  }
  ...
  getReserves(): SushiPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SushiPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
    );
  ...
  try_getReserves(): ethereum.CallResult<SushiPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      [],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
      ),
